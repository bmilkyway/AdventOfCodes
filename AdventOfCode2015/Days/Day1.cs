...
namespace AdventOfCode2015.Days
{
    public class Day1
    {
        ...
        #region Tasks
        public string Task1()=> String.Format("A mikulásnak a {0} emeletre kell vinnie a szajrét", getFloor());
     

        public string Task2() => String.Format("A miku a {0} alkalommal ment azt a pincébe",getCaller());
