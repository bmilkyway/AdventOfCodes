...
namespace AdventOfCode2015.Days
{
    public class Day5
    {
        ...
        {
            ReadingFile();
            return String.Format("A manóknak {0}  négyzetméternyi csomagolópapír kellene...", findAllNiceString());
        }
        ...
        public string Task2()
        {
            return String.Format("A manóknak a sok csomagoló cucc mellé még  láb szalag is kell");
        }
        #endregion
